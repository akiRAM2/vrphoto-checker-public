...
ollama pull gemma2
```
※ `gemma2` は執筆時点での推奨モデルです。`gemma3` が利用可能な場合は `ollama pull gemma3` とし、`config.json` を書き換えてください。
...
**Q. "Model 'gemma2' missing" と出る**
A. `ollama pull gemma2` コマンドを実行してモデルをダウンロードしてください。
